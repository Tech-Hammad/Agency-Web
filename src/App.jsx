...
useEffect(() => {
  ...
  const animate = () => {
    ...
    if (dotRef.current && outlineRef.current) {
      dotRef.current.style.transform =
        `translate3d(${position.current.x - 6}px, ${position.current.y - 6}px, 0)`;
  ...
  return (
    <div className="dark:bg-black relative">
      ...
      {/* Custome Cursor Dot*/}
      <div ref={dotRef} className="fixed top-0 left-0 h-2 w-2 bg-primary rounded-full pointer-events-none z-[9999]"
